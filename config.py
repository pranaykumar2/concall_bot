...
UPCOMING_RESULTS_API_URL = "https://api.concall.in/leap/fetch/upcomingResults"
...
# Upcoming Image Font Styles
UPCOMING_FONT_TITLE_STYLE = os.getenv('UPCOMING_FONT_TITLE_STYLE', '900')
UPCOMING_FONT_TABLE_HEADER_STYLE = os.getenv('UPCOMING_FONT_TABLE_HEADER_STYLE', '600')
UPCOMING_FONT_INDEX_STYLE = os.getenv('UPCOMING_FONT_INDEX_STYLE', '700')
UPCOMING_FONT_FINCODE_STYLE = os.getenv('UPCOMING_FONT_FINCODE_STYLE', '400')
UPCOMING_FONT_COMPANY_STYLE = os.getenv('UPCOMING_FONT_COMPANY_STYLE', '600')
...
# Upcoming Image Font Families
UPCOMING_FONT_TITLE_FAMILY = os.getenv('UPCOMING_FONT_TITLE_FAMILY', 'Fraunces')
UPCOMING_FONT_TABLE_HEADER_FAMILY = os.getenv('UPCOMING_FONT_TABLE_HEADER_FAMILY', 'Inter')
UPCOMING_FONT_INDEX_FAMILY = os.getenv('UPCOMING_FONT_INDEX_FAMILY', 'Fraunces')
UPCOMING_FONT_FINCODE_FAMILY = os.getenv('UPCOMING_FONT_FINCODE_FAMILY', 'Inter')
UPCOMING_FONT_COMPANY_FAMILY = os.getenv('UPCOMING_FONT_COMPANY_FAMILY', 'Inter')
